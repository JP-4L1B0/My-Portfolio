        ...
        <section id="home" className="relative flex min-h-[calc(100vh-76px)] w-full items-center overflow-hidden px-6 py-24 md:px-12">
            ...
            <div className="relative mx-auto flex w-full max-w-5xl flex-col" data-reveal>
                ...
                <div className="mt-9 flex flex-wrap gap-4">
                    ...
                    <a href="#contact" className="rounded-lg border border-emerald-700 px-5 py-3 font-medium text-emerald-800 transition hover:-translate-y-0.5 hover:bg-emerald-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-700">Get in touch</a>
                </div>
            </div>
        </section>
    );
